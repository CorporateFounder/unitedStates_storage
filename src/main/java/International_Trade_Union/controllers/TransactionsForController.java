...
import static International_Trade_Union.setings.Seting.MINIMUM;

@Component
public class TransactionsForController {

    @Autowired
    BlockService blockService;

    public static List<DtoTransaction> transactions_for_mining = new ArrayList<>();
    public List<DtoTransaction> calculateTransactionForGeting(){
        ...
        transactions_for_mining = transactions;
        return transactions;
    }
