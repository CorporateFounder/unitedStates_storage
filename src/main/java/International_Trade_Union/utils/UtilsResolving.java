...
//        SaveBalances.saveBalances(balances, Seting.ORIGINAL_BALANCE_FILE);
    ...
    public List<HostEndDataShortB> sortPriorityHost(Set<String> hosts) throws IOException, JSONException {
        ...
        for (String s : hosts) {
            DataShortBlockchainInformation global = null;
            try {
                String jsonGlobalData = UtilUrl.readJsonFromUrl(s + "/datashort");
                System.out.println("jsonGlobalData: " + jsonGlobalData);
                global = UtilsJson.jsonToDataShortBlockchainInformation(jsonGlobalData);
...
//                e.printStackTrace();
                System.out.println("-----------------------------------");
                System.out.println("error class UtilsResolving method: sortPriorityHost: ");
                System.out.println("-----------------------------------");
        ...
        System.out.println("finish: sortPriorityHost: " + list);
        return list;
    }
