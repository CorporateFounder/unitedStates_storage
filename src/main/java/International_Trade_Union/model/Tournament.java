...
public class Tournament implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            try {
                long currentTime = UtilsTime.getUniversalTimestampFromNTP();
                ...
                currentTime = UtilsTime.getUniversalTimestampFromNTP(); // Update current time
                ...
                Thread.sleep(TOURNAMENT_INTERVAL - (UtilsTime.getUniversalTimestampFromNTP() - nextTournamentStartTime));
