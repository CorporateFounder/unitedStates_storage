...
public class UtilsBalanceTest {
    ...
    public void rollbackBalance() throws IOException, NoSuchAlgorithmException, SignatureException, InvalidKeySpecException, NoSuchProviderException, InvalidKeyException, CloneNotSupportedException {
        ...
        Account testCustomer = customer.clone();
        Account testFounder = founder.clone();
        ...
        Assert.assertTrue(testCustomer.equals(customer) && testFounder.equals(founder));
        System.out.println("equals: " + (testCustomer.equals(customer) && testFounder.equals(founder)));
        System.out.println(balance.get(customer.getAccount()));
        System.out.println(balance.get(founder.getAccount()));
    }
